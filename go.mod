module github.com/aegershman/cf-usage-report-plugin
...
require (
	...
	github.com/cloudfoundry/bosh-cli v6.1.1+incompatible // indirect
	github.com/cloudfoundry/bosh-utils v0.0.0-20191123100134-1519f14bace7 // indirect
	github.com/cloudfoundry/cli v6.47.2+incompatible
	github.com/cloudfoundry/cli-plugin-repo v0.0.0-20191120190203-41755aff780a // indirect
